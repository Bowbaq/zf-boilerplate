...
class ServiceAttributeRepository extends EntityRepository
{
    public function removeAttributeAndValues($attribute)
    {
        $em = $this->getEntityManager();
        
        // Suppression des instances de l'attribut
        $em->createQuery('
            DELETE App\Entity\Service\ServiceValue v
